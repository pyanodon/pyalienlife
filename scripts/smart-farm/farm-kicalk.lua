local farm =
{
    ...
    {
        {
            recipe_name = "kicalk-super-1", -- recipe name
            crop_output = 1                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-2", -- recipe name
            crop_output = 2                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-3", -- recipe name
            crop_output = 3                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-4", -- recipe name
            crop_output = 4                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-5", -- recipe name
            crop_output = 5                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-6", -- recipe name
            crop_output = 6                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-7", -- recipe name
            crop_output = 7                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-8", -- recipe name
            crop_output = 8                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-9", -- recipe name
            crop_output = 9                 -- crop yield
        },
        {
            recipe_name = "kicalk-super-10", -- recipe name
