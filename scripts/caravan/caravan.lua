...
Caravan.events.used_capsule = function(event)
	...
	local entity = player.selected or player.surface.find_entities_filtered{
		...
		limit = 1,
		collision_mask = {layers = {['object-layer'] = true, ['player-layer'] = true, ['train-layer'] = true, ['resource-layer'] = true, ['floor-layer'] = true, ['transport-belt-layer'] = true, ['ghost-layer'] = true}}
	}[1]
	if entity then
