...
RECIPE {
    ...
    ingredients = {
        ...
        {type = "item",  name = mods.pyalternativeenergy and "zungror" or "auog",                               amount = 1},
        {type = "item",  name = "power-armor",                                                                  amount = 1},
        {type = "item",  name = mods.pyalternativeenergy and "hydraulic-system-mk01" or "copper-plate",         amount = 8},
        ...
        {type = "item",  name = mods.pyalternativeenergy and "dieletric-layer" or "iron-plate",                 amount = 8},
        {type = "item",  name = "high-grade-lead",                                                              amount = 8},
        {type = "item",  name = mods.pyalternativeenergy and "zungror-codex" or "electronic-circuit",           amount = 1}
    },
    results = {
