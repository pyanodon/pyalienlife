...
ENTITY{
  ...
  icon = ENTITY('dino-dig-site', 'assembling-machine').icon,
  icon_size = ENTITY('dino-dig-site', 'assembling-machine').icon_size,
  flags = {'hidden', 'not-blueprintable', 'not-in-made-in'},
  minable = ENTITY('dino-dig-site', 'assembling-machine').minable,
  collision_box = ENTITY('dino-dig-site', 'assembling-machine').collision_box,
  selection_box = ENTITY('dino-dig-site', 'assembling-machine').selection_box,
  animation = ENTITY('dino-dig-site', 'assembling-machine').animation,
  energy_usage = '1W',
  energy_source = ENTITY('dino-dig-site', 'assembling-machine').energy_source,
