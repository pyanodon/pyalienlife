...
local caravan_prototypes = {
    ...
    fluidavan = {
        opens_player_inventory = true,
        -- TODO this is nil for some reason
       -- max_volume = data.raw["storage-tank"]["py-tank-4000"].fluid_capacity,
        max_volume = 40000,
        fuel_size = 2,
        destructible = false,
    ...
    fluidflyavan = {
        opens_player_inventory = true,
        max_volume = data.raw["storage-tank"]["py-tank-10000"].fluid_capacity,
        fuel_size = 4,
        destructible = false,
...
data:extend({
   { 
        type = "mod-data",
        name = "pyanadons",
        data_type = "py.caravan_prototypes",
        data ={
            ["caravan_prototypes"] = caravan_prototypes,
