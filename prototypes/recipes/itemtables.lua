...
items.inputs.copper = {'copper-ore', 1}
items.inputs.saps = {'saps', 1}
items.inputs.hydrogen = {'hydrogen', 10}
items.inputs.manurebacteria = {'manure-bacteria', 10}
...
items.inputs.mukmoux = {'mukmoux', 1}
...
items.inputs.emptycomb = {'empty-comb', 1}
items.inputs.emptyhoneycomb = {'empty-honeycomb', 1}
items.inputs.honeycomb = {'honeycomb', 1}
items.inputs.honeybarrel = {'arqad-honey-barrel', 1}
items.inputs.coal = {'coal', 1}
