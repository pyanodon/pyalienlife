...
items.outputs.b = {'meat',1}
items.outputs.c = {'bones', 1}
items.outputs.d = {'blood',10}
items.outputs.e = {'skin', 1}
items.outputs.f = {'brain',1}
items.outputs.g = {'guts',1}
items.outputs.h = {'mukmoux-fat',1}
