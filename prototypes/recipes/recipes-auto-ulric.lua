...
fun.autorecipes {
    ...
    mats =
	{
		...
		--bmp
		{
			...
			results =
				{
					{name='brain-caged-ulric', amount ='R'},
		...
		--rna anabolic
		{
			...
			results =
				{
					{name='bone-caged-ulric', amount ='R'},
		...
		--antitumor
		{
			...
			results =
				{
					{name='meat-caged-ulric', amount ='R'},
		...
		--Recombinant Ery
		{
			...
			results =
				{
					{name='guts-caged-ulric', amount ='R'},
		...
		--reca
		{
			...
			results =
				{
					{name='blood-caged-ulric', amount ='R'},
		...
		--orexigenic
		{
			...
			results =
				{
					{name='skin-caged-ulric', amount ='R'},
