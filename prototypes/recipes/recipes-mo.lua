...
}:add_unlock("antitumor"):change_category('nano'):replace_ingredient("cytostatics", "superconductor-servomechanims"):replace_ingredient("nonconductive-phazogen", "nanochip")
