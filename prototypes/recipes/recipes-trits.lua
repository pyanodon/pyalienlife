...
RECIPE {
    ...
    energy_required = 30,
    ingredients = {
        {type = 'item', name = 'trits-mk02', amount = 2},
    ...
    results = {
        {type = 'item', name = 'trits-mk03', amount = 1, probability = 0.005},
        --{type = 'item', name = 'empty-barrel', amount = 7},
    },
...
RECIPE {
    ...
    energy_required = 30,
    ingredients = {
        {type = 'item', name = 'trits-mk03', amount = 2},
    ...
    results = {
        {type = 'item', name = 'trits-mk04', amount = 1, probability = 0.005},
        --{type = 'item', name = 'empty-barrel', amount = 7},
    },
