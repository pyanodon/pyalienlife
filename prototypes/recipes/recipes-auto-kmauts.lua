...
fun.autorecipes {
    ...
    mats =
	{
		...
		--brain kmauts rendering
		{
			...
			crafting_speed = 15,
			tech = 'nanochondria',
			name = 'Extract brains from Improved kmautss',
		...
		--guts kmauts rendering
		{
			...
			crafting_speed = 15,
			tech = 'antitumor',
			name = 'Extract guts from Improved kmautss',
		...
		--blood kmauts rendering
		{
			...
			crafting_speed = 15,
			tech = 'recombinant-ery',
			name = 'Extract blood from Improved kmautss',
		...
		--meat kmauts rendering
		{
			...
			crafting_speed = 15,
			tech = 'anabolic-rna',
			name = 'Extract meat from Improved kmautss',
		...
		--fat kmauts rendering
		{
			...
			crafting_speed = 15,
			tech = 'orexigenic',
			name = 'Extract fat from Improved kmautss',
