...
RECIPE('genlab'):remove_unlock('fusion-mk01'):add_unlock('microbiology-mk01'):remove_ingredient("assembling-machine-3"):subgroup_order('py-alienlife-buildings-others', 'a')
----RECIPES----
