...
RECIPE('space-science-pack'):add_ingredient({type = "item", name = "strangelets", amount = 5}):add_ingredient({type = "item", name = "yellow-cake", amount = 2}):add_ingredient({type = "item", name = "intelligent-unit", amount = 6})
