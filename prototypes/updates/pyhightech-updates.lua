...
TECHNOLOGY('graphene'):add_pack('py-science-pack')
TECHNOLOGY('nano-tech'):add_pack('py-science-pack')
...
RECIPE('cottongut-science-utility'):replace_ingredient("perfect-samples", "destablilized-toxirus"):add_ingredient({type = "item", name = "hormonal", amount = 1}):add_ingredient({type = "item", name = "dimensional-gastricorg", amount = 1})
...
RECIPE('processing-unit'):add_ingredient({type = 'item', name = 'mosfet', amount = 10})
