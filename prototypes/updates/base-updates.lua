...
local spidertron = data.raw['item-with-entity-data'].spidertron
spidertron.icon = '__pyalienlifegraphics__/graphics/icons/spidertron.png'
spidertron.icon_size = 64
spidertron.icon_mipmaps = nil
spidertron.icon_tintable = spidertron.icon
