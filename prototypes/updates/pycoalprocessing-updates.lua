...
TECHNOLOGY("railway"):add_pack("py-science-pack-1")
...
RECIPE("bonemeal"):remove_unlock("ulric"):hide()
...
RECIPE("py-construction-robot-mk01"):add_ingredient {type = "fluid", name = "fish-oil", amount = 50}
