...
}:add_unlock("kmauts-mk03"):add_ingredient({type = "item", name = "small-parts-02", amount = 30})

ITEM {
    type = "item",
    name = "kmauts-enclosure-mk03",
    icon = "__pyalienlife__/graphics/icons/kmauts-enclosure-mk03.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    working_sound = {
        sound = {filename = "__pyfusionenergy__/sounds/kmauts-enclosure.ogg", volume = 1.2},
