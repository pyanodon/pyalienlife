...
ITEM {
    type = "item",
    name = "test-building-mk01",
    icon = "__pyalienlife__/graphics/icons/vrauks-paddock-mk01.png",
    icon_size = 64,
    flags = {},
    subgroup = "py-alienlife-buildings-mk01",
    order = "c",
    place_result = "test-building-mk01",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "test-building-mk01"},
    ...
    animation = {
        layers = {
            {
                filename = "__pyalienlife__/graphics/entity/vrauks-paddock/vrauks-paddock-mk01.png",
                width = 448,
                height = 448,
                --line_length = 5,
                frame_count = 1,
