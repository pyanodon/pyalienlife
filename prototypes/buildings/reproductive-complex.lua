...
for i = 1, 4 do
    ...
    ENTITY {
        ...
        working_sound = {
            sound = {filename = "__pyalienlifegraphics2__/sounds/rc.ogg", volume = 0.7, audible_distance_modifier = 1,},
            idle_sound = {filename = "__pyalienlifegraphics2__/sounds/rc.ogg", volume = 0.4, audible_distance_modifier = 1,},
