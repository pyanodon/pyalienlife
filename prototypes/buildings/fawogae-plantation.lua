...
data.raw["assembling-machine"]["fawogae-plantation-mk01"].effect_receiver = {base_effect = {speed = -1}, speed_limits = {low = -0.9999}}
data.raw["assembling-machine"]["fawogae-plantation-mk01"].crafting_speed = py.farm_speed(MODULE_SLOTS * 1, FULL_CRAFTING_SPEED)
data.raw["assembling-machine"]["fawogae-plantation-mk01"].module_slots = MODULE_SLOTS * 1

RECIPE("fawogae-plantation-mk02"):add_unlock("mycology-mk03")
data.raw["assembling-machine"]["fawogae-plantation-mk02"].effect_receiver = {base_effect = {speed = -1}, speed_limits = {low = -0.9999}}
...
data.raw["assembling-machine"]["fawogae-plantation-mk03"].effect_receiver = {base_effect = {speed = -1}, speed_limits = {low = -0.9999}}
...
data.raw["assembling-machine"]["fawogae-plantation-mk04"].effect_receiver = {base_effect = {speed = -1}, speed_limits = {low = -0.9999}}
