...
ITEM {
    type = "item",
    name = "kmauts-enclosure-mk02",
    icon = "__pyalienlifegraphics__/graphics/icons/kmauts-enclosure-mk02.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    crafting_speed = FUN.farm_speed_derived(MODULE_SLOTS, "kmauts-enclosure-mk01"),
    energy_source = {
        type = "electric",
