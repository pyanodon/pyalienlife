...
}:add_unlock("vrauks-mk03"):add_ingredient({type = "item", name = "small-parts-03", amount = 30})

ITEM {
    type = "item",
    name = "vrauks-paddock-mk03",
    icon = "__pyalienlife__/graphics/icons/vrauks-paddock-mk03.png",
    icon_size = 64,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyalienlife__/graphics/entity/vrauks-paddock/vrauks-paddock-mk03.png",
                width = 448,
                height = 448,
                --line_length = 5,
                frame_count = 1,
