...
ENTITY {
    ...
    max_health = 700,
    resource_categories = {"ralesia-flowers","rennea-flowers","tuuphra-tuber","grod-flower","yotoi-tree","yotoi-tree-fruit","kicalk-tree"},
    corpse = "big-remnants",
    ...
    energy_usage = "600kW",
    mining_power = 2,
    resource_searching_radius = 4.5,
    vector_to_place_result = {0, -4.05},
