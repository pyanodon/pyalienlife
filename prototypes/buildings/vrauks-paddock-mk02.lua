...
}:add_unlock("vrauks-mk02"):add_ingredient({type = "item", name = "small-parts-02", amount = 30})
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyalienlifegraphics2__/graphics/entity/vrauks-paddock/vrauks-paddock-mk02.png",
                width = 448,
                height = 448,
                --line_length = 5,
                frame_count = 1,
