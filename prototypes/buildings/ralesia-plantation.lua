...
data.raw["assembling-machine"]["ralesia-plantation-mk01"].effect_receiver = {base_effect = {speed = -1}, speed_limits = {low = -0.9999}}
...
data.raw["assembling-machine"]["ralesia-plantation-mk02"].effect_receiver = {base_effect = {speed = -1}, speed_limits = {low = -0.9999}}
