...
if data then
    ...
    if mods.pyalternativeenergy then FUN.add_ingredient(py_science_3, {name = 'passivation-layer', amount = 4, type = 'item'}) end
    FUN.add_ingredient(py_science_4, {name = 'mova-pulp3', amount = 120, type = 'fluid'})
