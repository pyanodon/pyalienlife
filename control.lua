...
require('scripts/crops/farm-grod')
require('scripts/crops/farm-yotoi')
require('scripts/crops/farm-kicalk')
require('scripts/crops/farm-arum')
require('scripts/crops/farm-yotoi-fruit')
